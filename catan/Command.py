...
class Command:
    ...
    def execute_trade(self, sim):
        ...
        while trade:
            ...
            print(f'Player {sim.current_player.name}, your resources: ')
    ...
    def execute_build(self, sim):
        # execute build code here
        pass
